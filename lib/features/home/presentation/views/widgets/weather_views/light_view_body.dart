...
class LightViewBody extends StatelessWidget {
  const LightViewBody({super.key, required this.weatherModel});
      ...
      child: Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            CustomForecastList(weatherModel: weatherModel, textColor: kFontBlack1),
          ],
        ),
      ),
    );
